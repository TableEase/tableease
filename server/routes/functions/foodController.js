...
const foodAllergiesFunctions = require("./foodAllergiesController");
...
module.exports = {
  ...
  updateFood: function(req, companyId, checkedAllergies, callback) {
    ...
    food.save(function(err, rows, fields) {
      if (err) throw err;
      return callback(foodAllergiesFunctions.addFoodAllergy(food.id, checkedAllergies));
    });
  },
  addFood: function(req, companyId, callback) {
    ...
    food.save(function(err, rows, fields) {
      ...
      return callback(foodAllergiesFunctions.addFoodAllergy(rowId, checkedAllergies));
    });
  },
